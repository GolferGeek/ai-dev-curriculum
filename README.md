...
This repo contains the **complete curriculum** with all phases, apps, tools, and documentation. To follow along step by step, start at Phase 00:
...
|-------|---------------|------------|
| **00 — Your first AI build** | The pipeline: intention → PRD → plan → build | `git checkout phase-00` |
| **01 — SaaS killers** | Real apps with auth, databases, and tests | `git checkout phase-01` |
